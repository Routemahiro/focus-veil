...
Focus Veilは、Windows上の作業画面に薄い透明オーバーレイを重ねるElectronアプリです。背面アプリのクリック操作を通常時は妨げず、マウス周辺だけを柔らかく明るく見せます。

初期テーマは控えめな水面です。低速・低コントラスト・低密度のCanvas描画に留め、ポモドーロの残り時間と静かな通知演出で集中/休憩の切り替えを支援します。
